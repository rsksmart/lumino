...
def channel_state_until_state_change(
    raiden: "RaidenService", canonical_identifier: CanonicalIdentifier, state_change_identifier: int
    ...
    channel_state = views.get_channelstate_by_canonical_identifier_and_address(
        chain_state=chain_state, canonical_identifier=canonical_identifier, address=raiden.address
    )
