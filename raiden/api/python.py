    ...
    def create_light_client_payment(
        ...
        if channel_state:
            ...
            locked_transfer, merkle_tree_state = channel.create_sendlockedtransfer(
                ...
                lt_autogenerated_values.secrethash
            )
            # Get the LockedTransfer message
            locked_transfer = LockedTransfer.from_event(locked_transfer)
            # Create the light_client_payment
            is_lc_initiator = 1
            payment = LightClientPayment(lt_autogenerated_values.secret, creator_address, partner_address,
            ...
            return HubMessage(light_client_message_id, order, payment.payment_secret, locked_transfer)
        else:
