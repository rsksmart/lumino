...
class RaidenEventHandler(EventHandler):
    ...
    def handle_send_lockexpired(raiden: "RaidenService", send_lock_expired: SendLockExpired):
        ...
        raiden.transport.hub_transport.send_message(send_lock_expired.queue_identifier, lock_expired_message)
    ...
    def handle_send_lockedtransfer_light(
        ...
        for light_client_transport in raiden.transport.light_client_transports:
            if light_client_address == light_client_transport.address:
                light_client_transport.send_message(send_locked_transfer_light.queue_identifier,
    ...
    def handle_send_secretreveal(raiden: "RaidenService", reveal_secret_event: SendSecretReveal):
        ...
        raiden.transport.hub_transport.send_message(reveal_secret_event.queue_identifier, reveal_secret_message)
    ...
    def handle_send_balanceproof(raiden: "RaidenService", balance_proof_event: SendBalanceProof):
        ...
        raiden.transport.hub_transport.send_message(balance_proof_event.queue_identifier, unlock_message)
    ...
    def handle_send_balanceproof_light(raiden: "RaidenService", balance_proof_event: SendBalanceProofLight):
        ...
        if lc_transport:
            lc_transport.send_message(balance_proof_event.queue_identifier, unlock_message)
    ...
    def handle_send_secretrequest(
        ...
        raiden.transport.hub_transport.send_message(secret_request_event.queue_identifier, secret_request_message)
    ...
    def handle_send_secretrequest_light(
        ...
        if lc_transport:
            lc_transport.send_message(secret_request_event.queue_identifier, secret_request_message)
    ...
    def handle_send_processed(raiden: "RaidenService", processed_event: SendProcessed):
        ...
        raiden.transport.hub_transport.send_message(processed_event.queue_identifier, processed_message)
